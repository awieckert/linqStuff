...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(x => x.JuniorInstructors.Count >= 2);
        ...
        {
            var doAll = PracticeData.All(x => x.Students.Count == 5);
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.All(x => x.PrimaryInstructor.Active == true);
        ...
        {
            var doAll = PracticeData[0].Students.All(x => x.FirstName.ToLower().Contains('e'));/*FILL IN LINQ EXPRESSION*/; //Hint: Cohort1 would be PracticeData[0]
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
